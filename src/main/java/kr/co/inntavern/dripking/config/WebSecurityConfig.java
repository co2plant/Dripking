    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, CorsConfigurationSource corsConfigurationSource) throws Exception {
        http
                ...
                .authorizeHttpRequests(registry -> registry
                        .requestMatchers(HttpMethod.GET, "/api/reviews/my").hasAuthority("ROLE_USER") // 내 리뷰 조회
                        // --- 공개 접근 가능 API ---
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/reviews/{reviewId}/reports").hasAuthority("ROLE_USER") // 리뷰 신고
