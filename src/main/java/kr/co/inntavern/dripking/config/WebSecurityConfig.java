...
import kr.co.inntavern.dripking.security.UserDetailsServiceImpl;
...
public class WebSecurityConfig {
    ...
    public DaoAuthenticationProvider authenticationProvider(){
        ...
        daoAuthenticationProvider.setUserDetailsService((UserDetailsService) userDetailsServiceImpl);
